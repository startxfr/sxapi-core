...
| **corsOptions**                 |    no     |  obj   | obj     | Options to use with the Express Cors. See [express cors configuration options](https://github.com/expressjs/cors#configuration-options)               |
