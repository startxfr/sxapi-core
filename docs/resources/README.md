...
| **memcache**     | memcache v0.3.2    | [read](memcache.md)    | Resource to interact with a memcache server.
...
If you wan't to see sample sxapi.yml config for various resources, you can visit [sxapi-sample project](https://github.com/startxfr/sxapi-sample/tree/dev/samples)
