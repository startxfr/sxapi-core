...
Build status : [![Build Status](https://travis-ci.org/startxfr/sxapi-core.svg?tag=v0.0.52-docker)](https://travis-ci.org/startxfr/sxapi-core)
...
[![Build Status](https://travis-ci.org/startxfr/sxapi-core.svg?tag=v0.0.52-docker)](https://travis-ci.org/startxfr/sxapi-core) 
...
- [source code](https://github.com/startxfr/sxapi-core/tree/v0.0.52-docker) published in github
