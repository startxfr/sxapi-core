...
Build status : [![Build Status](https://travis-ci.org/startxfr/sxapi-core.svg?tag=v0.0.52-npm)](https://travis-ci.org/startxfr/sxapi-core)
...
- [source code](https://github.com/startxfr/sxapi-core/tree/v0.0.52-npm) published in github
